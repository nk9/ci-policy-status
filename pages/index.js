...
export default function Index() {
  return (
    <Container maxWidth="md">
      ...
      <Box sx={{ my: 4, mt: 15 }}>
        <Image src="/static/images/sustainable-modal-share.jpg" layout="intrinsic" width="900" height="200" alt="A cyclist and an e-scooter rider travel together on a road." />
